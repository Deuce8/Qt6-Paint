...
the [Qt6 website](https://doc.qt.io/qt-6/get-and-install-qt.html). You will also need to install cmake, and git if you
want to clone the project from a terminal. These instructions assume linux, so will have to be tailored depending on
your operating system.

Afterwards you can clone the repository and build using cmake:
...
I didn't use qmake because I already had some minor cmake experience and there were more resources online to pull from.
I will eventually swap to qmake or maintain both systems as soon as I learn the qmake syntax.
...
coordinates and scalings when using QRect. The same applies to QPoint vs QPointF.
